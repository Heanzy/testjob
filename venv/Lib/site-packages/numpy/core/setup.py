...
class CallOnceOnly:
    ...
    def check_types(self, *a, **kw):
        if self._check_types is None:
            ...
            out = copyAction.deepcopy(pickle.loads(self._check_types))
        return out
    ...
    def check_ieee_macros(self, *a, **kw):
        if self._check_ieee_macros is None:
            ...
            out = copyAction.deepcopy(pickle.loads(self._check_ieee_macros))
        return out
    ...
    def check_complex(self, *a, **kw):
        if self._check_complex is None:
            ...
            out = copyAction.deepcopy(pickle.loads(self._check_complex))
        return out
